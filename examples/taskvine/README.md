...
- [MobileNet Batch Inference](mobilenet-batch-inference/README.md) — compare ordinary PythonTasks with persistent Function Calls using the same image-classification application.
